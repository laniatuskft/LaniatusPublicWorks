...
#ORIGINAL LINE: str_to_number(pkTab->players[j].y, row[col++]);
                        ...
                        col += 1
#Laniatus Games Studio Inc. | Python Metin II Server Warnings An assignment within expression was extracted from the following statement:
#ORIGINAL LINE: str_to_number(pkTab->players[j].skill_group, row[col++]);
...
# Laniatus Games Studio Inc. |  TODO TASK: There is no Python equivalent to 'sizeof':
        ...
        queryLen += snprintf(pszQuery.arg_value + queryLen, querySize - queryLen, "skill_level = '%s', ", CreatePlayerSaveQuery_text)
...
#ORIGINAL LINE: str_to_number(pkTab->stat_point, row[col++]);
        ...
        col += 1
#Laniatus Games Studio Inc. | Python Metin II Server Warnings An assignment within expression was extracted from the following statement:
#ORIGINAL LINE: str_to_number(pkTab->skill_point, row[col++]);
        str_to_number(pkTab.skill_point, row[col])
        col += 1
#Laniatus Games Studio Inc. | Python Metin II Server Warnings An assignment within expression was extracted from the following statement:
#ORIGINAL LINE: str_to_number(pkTab->sub_skill_point, row[col++]);
...
#Laniatus Games Studio Inc. | Python Metin II Server Warnings An assignment within expression was extracted from the following statement:
#ORIGINAL LINE: str_to_number(pkTab->skill_group, row[col++]);
...
#ORIGINAL LINE: str_to_number(pkTab->logoff_interval, row[col++]);
        ...
        col += 1
#Laniatus Games Studio Inc. | Python Metin II Server Warnings An assignment within expression was extracted from the following statement:
#ORIGINAL LINE: str_to_number(pkTab->horse_skill_point, row[col++]);
        str_to_number(pkTab.horse_skill_point, row[col])
            ...
            if pkTab.level > 9:
                ...
                skill_point = MIN(20, pkTab.skills[121].bLevel) + MIN(20, pkTab.skills[124].bLevel) + MIN(10, pkTab.skills[131].bLevel) + MIN(20, pkTab.skills[141].bLevel) + MIN(20, pkTab.skills[142].bLevel)
