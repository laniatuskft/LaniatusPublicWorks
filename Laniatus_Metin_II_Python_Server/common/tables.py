...
class SSimplePlayer:
    ...
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.dwID = 0
        self.szName = str(['\0' for _ in range((int)EMisc.CHARACTER_NAME_MAX_LEN + 1)])
        self.byJob = 0
        self.byLevel = 0
...
class SAccountTable:
    ...
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.id = 0
        self.login = str(['\0' for _ in range((int)EMisc.LOGIN_MAX_LEN + 1)])
        self.passwd = str(['\0' for _ in range((int)EMisc.PASSWD_MAX_LEN + 1)])
        self.social_id = str(['\0' for _ in range((int)EMisc.SOCIAL_ID_MAX_LEN + 1)])
        self.status = str(['\0' for _ in range((int)EMisc.ACCOUNT_STATUS_MAX_LEN + 1)])
        self.bEmpire = 0
        self.bLanguage = 0
        self.players = [SSimplePlayer() for _ in range((int)EMisc.PLAYER_PER_ACCOUNT)]
...
class SPlayerItem:
    ...
    def __init__(self):
        ...
        self.count = 0
        self.vnum = 0
        self.alSockets = [0 for _ in range((int)EItemMisc.ITEM_SOCKET_MAX_NUM)]
...
class SPlayerTable:
    ...
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.id = 0
        self.name = str(['\0' for _ in range((int)EMisc.CHARACTER_NAME_MAX_LEN + 1)])
        self.ip = str(['\0' for _ in range((int)EMisc.IP_ADDRESS_LENGTH + 1)])
        self.job = 0
        self.voice = 0
        self.level = 0
        self.level_step = 0
        ...
        self.stat_point = 0
        self.skill_point = 0
        self.sub_skill_point = 0
        self.horse_skill_point = 0
        self.skills = [SPlayerSkill() for _ in range((int)EMisc.SKILL_MAX_NUM)]
        self.quickslot = [SQuickslot() for _ in range((int)EMisc.QUICKSLOT_MAX_NUM)]
        self.part_base = 0
...
class SMobTable(SEntityTable):
    ...
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.szName = str(['\0' for _ in range((int)EMisc.CHARACTER_NAME_MAX_LEN + 1)])
        self.szLocaleName = str(['\0' for _ in range((int)EMisc.CHARACTER_NAME_MAX_LEN + 1)])
        self.bType = 0
        self.bRank = 0
        self.bBattleType = 0
        self.bLevel = 0
        ...
        self.Skills = [SMobSkillLevel() for _ in range((int)EMisc.MOB_SKILL_MAX_NUM)]
...
class SShopTable:
    ...
    def __init__(self):
        ...
        self.dwNPCVnum = 0
        self.byItemCount = 0
        self.items = [SShopItemTable() for _ in range((int)EMisc.SHOP_HOST_ITEM_MAX_NUM)]
...
class TItemAttrTable:
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.szApply = str(['\0' for _ in range((int)EMisc.APPLY_NAME_MAX_LEN + 1)])
        self.dwApplyIndex = 0
        self.dwProb = 0
...
class SSafeboxLoadPacket:
    ...
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.dwID = 0
        self.szLogin = str(['\0' for _ in range((int)EMisc.LOGIN_MAX_LEN + 1)])
...
class SMapLocation:
    ...
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.alMaps = [0 for _ in range(32)]
        self.szHost = str(['\0' for _ in range((int)EMisc.MAX_HOST_LENGTH + 1)])
        self.wPort = 0
...
class SPacketGuildSkillUpdate:
    ...
    def __init__(self):
        ...
        self.guild_id = 0
        self.amount = 0
        self.skill_levels = [0 for _ in range(12)]
        self.skill_point = 0
        self.save = 0
...
class SPacketGDAuthLogin:
    ...
    def __init__(self):
        ...
        self.dwLoginKey = 0
        self.szLogin = str(['\0' for _ in range((int)EMisc.LOGIN_MAX_LEN + 1)])
        self.szSocialID = str(['\0' for _ in range((int)EMisc.SOCIAL_ID_MAX_LEN + 1)])
...
class SPacketGDLoginByKey:
    ...
    def __init__(self):
        ...
        self.dwLoginKey = 0
        self.adwClientKey = [0 for _ in range(4)]
        self.szIP = str(['\0' for _ in range((int)EMisc.MAX_HOST_LENGTH + 1)])
...
class SPacketSetEventFlag:
    ...
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.szFlagName = str(['\0' for _ in range((int)EMisc.EVENT_FLAG_NAME_MAX_LEN + 1)])
        self.lValue = 0
...
class TPacketMarriageAdd:
    ...
    def __init__(self):
        ...
        self.szName1 = str(['\0' for _ in range((int)EMisc.CHARACTER_NAME_MAX_LEN + 1)])
        self.szName2 = str(['\0' for _ in range((int)EMisc.CHARACTER_NAME_MAX_LEN + 1)])
...
class SItemPriceListTable:
    ...
    def __init__(self):
        ...
        self.dwOwnerID = 0
        self.wCount = 0
        self.aPriceInfo = [SItemPriceInfo() for _ in range((int)EMisc.SHOP_PRICELIST_MAX_NUM)]
...
class tUpdateHorseName:
    ...
    def __init__(self):
        #instance fields found by Laniatus Games Studio Inc. T.F |:
        self.dwPlayerID = 0
        self.szHorseName = str(['\0' for _ in range((int)EMisc.CHARACTER_NAME_MAX_LEN + 1)])
